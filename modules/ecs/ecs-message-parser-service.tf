...
resource "aws_ecs_task_definition" "message_parser" {
    family                   = "message-parser-app-task"
...
resource "aws_ecs_service" "message-parser" {
    ...
    task_definition = aws_ecs_task_definition.message_parser.arn
    ...
    load_balancer {
        ...
        container_name   = "message-parser-app"
